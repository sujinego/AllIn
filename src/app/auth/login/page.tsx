...
function KakaoIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
      <path fill="#3C1E1E" fillRule="evenodd" clipRule="evenodd" d="M9 1.5C4.858 1.5 1.5 4.19 1.5 7.5c0 2.1 1.275 3.945 3.21 5.03l-.81 3.015c-.075.27.24.487.477.328l3.645-2.385c.315.03.636.047.978.047 4.142 0 7.5-2.69 7.5-6 0-3.31-3.358-6-7.5-6z"/>
    </svg>
  )
}
...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  naver_no_email: '네이버 계정에 이메일이 없습니다. 이메일 로그인을 사용해주세요.',
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            style={{ background: 'white', borderColor: '#dadce0', color: '#3c4043' }}
          >
            <GoogleIcon />
